...
from tdmpc2.common.layers import EnsembleStochasticLinear , EnsembleStochasticLinearUnitVariance
...
class WorldModel(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # self._dynamics = EnsembleStochasticLinear(cfg.latent_dim + cfg.action_dim + cfg.task_dim, cfg.latent_dim, cfg.mlp_dim, ensemble_size=cfg.num_r_d) 
        if cfg.train_reward:
    ...
    def next_single_member(self, z, a, index):
        """
